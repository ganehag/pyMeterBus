...
class TelegramHeader(object):
	...
	def debug(self):
		print "Start Field:".ljust(30), 		hex(self.startField.fieldParts[0])
		print "Length of Telegram:".ljust(30),	hex(self.lField.fieldParts[0])
		print "C-Field (mode):".ljust(30),		hex(self.cField.fieldParts[0])
		print "A-Field (mode):".ljust(30),		hex(self.aField.fieldParts[0])
		print "CRC:".ljust(30),					hex(self.crcField.fieldParts[0])
		print "Stop Field:".ljust(30),			hex(self.stopField.fieldParts[0])